...
exports.login = async (req, res) => {
  ...
  try {
    ...
    if (!token) throw Error("Something critical happened 32445435")
...
exports.signup = async (req, res) => {
  ...
  try {
    ...
    if (!salt) throw Error("Something critical happened 4154345")

    const hash = await bcrypt.hash(password, salt)
    if (!hash) throw Error("Something critical happened 31243425")
